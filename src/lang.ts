const lang = {
  ...
  'Message.Unsupported.Desktop': '__This message is currently not supported on Metastem Telegram. Try [getdesktop.telegram.org](https://getdesktop.telegram.org/)__',
  'Message.Unsupported.Mobile': '__This message is currently not supported on Metastem Telegram. Try [telegram.org/dl](https://telegram.org/dl/)__',
